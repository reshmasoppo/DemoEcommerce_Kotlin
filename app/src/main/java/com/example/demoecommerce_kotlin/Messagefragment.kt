...
class Messagefragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        messagelist.add(MessageContent(R.drawable.img_3, "Kelly R.Hart","Accepts one silver as content","63 min ago"))
        messagelist.add(MessageContent(R.drawable.img_3, "Carol R.Hansen","Can scroll in any direction","32 min ago"))
        messagelist.add(MessageContent(R.drawable.img_3, "Kelly R.Hart","Accepts one silver as content","63 min ago"))
        messagelist.add(MessageContent(R.drawable.img_3, "Carol R.Hansen","Can scroll in any direction","32 min ago"))
        messagelist.add(MessageContent(R.drawable.img_3, "Kelly R.Hart","Accepts one silver as content","63 min ago"))
        messagelist.add(MessageContent(R.drawable.img_3, "Carol R.Hansen","Can scroll in any direction","32 min ago"))
